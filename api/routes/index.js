...
router.get('/changeTrust', function (req, res) {// change trustline and make tx
...
router.get('/recentTransactions', function (req, res) {
    ...
    var urll = 'https://horizon-testnet.stellar.org/accounts/' + account2.publicKey + '/operations?order=desc&limit=200';
    console.log(urll);
    request.get({
        url: urll,
        json: true
